...
final imageAnalysisRepositoryProvider = Provider<ImageAnalysisRepository>((ref) {
  final client = ref.watch(supabaseClientProvider);
  return ImageAnalysisRepositoryImpl(client);
});

final createImageAnalysisUseCaseProvider = Provider<CreateImageAnalysisUseCase>((ref) {
  final repo = ref.watch(imageAnalysisRepositoryProvider);
  return CreateImageAnalysisUseCase(repo);
});

final listImageAnalysesForUserUseCaseProvider = Provider<ListImageAnalysesForUserUseCase>((ref) {
  final repo = ref.watch(imageAnalysisRepositoryProvider);
  return ListImageAnalysesForUserUseCase(repo);
});

final imageAnalysesByUserProvider = FutureProvider.autoDispose.family<List<ImageAnalysis>, String>((ref, userId) {
